        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function requestGeolocation() {
                if (navigator.geolocation) {
                    ...
                    navigator.geolocation.getCurrentPosition(
                        ...
                        function(error) {
                            console.error('Error al obtener ubicación:', error.message || error); // Log message if available
            ...
            function filterLocations() {
                ...
                // Control visibility of "Ubicaciones Destacadas" title and main map image
                if (searchTerm === "") {
                    ubicacionesDestacadasTitle.style.display = 'block';
                    mainMapImage.style.display = 'block';
